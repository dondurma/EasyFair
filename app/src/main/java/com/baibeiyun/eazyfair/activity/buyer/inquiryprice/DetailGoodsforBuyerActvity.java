...
public class DetailGoodsforBuyerActvity extends BaseActivityforBuyer implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_detail_goodsfor_buyer_actvity);
        initYuyan();
        initview();
        initAboutPic();
    }
    ...
    private void initYuyan() {
        ...
        language = CursorUtils.selectYuYan(DetailGoodsforBuyerActvity.this);
        if (language != null) {
    ...
    private void initview() {
        ...
        fanhui_rl.setOnClickListener(DetailGoodsforBuyerActvity.this);
        more_rv.setOnClickListener(DetailGoodsforBuyerActvity.this);

        Intent intent = getIntent();
        id = intent.getIntExtra("id", 0);

        myCommodity = CursorUtils.selectById(DetailGoodsforBuyerActvity.this, id);
        //将实体类里面的数据显示到控件上
        ...
        goodsDetailParameterAdapter = new GoodsDetailParameterAdapter(datas, DetailGoodsforBuyerActvity.this);
    ...
    private void initPopupWindow() {
        ...
        //设置背景半透明
        backgroundAlpha(DetailGoodsforBuyerActvity.this, 0.5f);
        //关闭事件
        ...
        msg_ch_ll.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(DetailGoodsforBuyerActvity.this, SendGoodsDataActivity.class);
    ...
    private class popupDismissListener implements PopupWindow.OnDismissListener {
        ...
        public void onDismiss() {
            backgroundAlpha(DetailGoodsforBuyerActvity.this, 1f);
        }
        ...
        for (int i = 0; i < resId.length; i++) {
            ...
            imageView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View arg0) {
                    // 跳到查看大图界面
                    Intent intent = new Intent(DetailGoodsforBuyerActvity.this, ShowBigPicture.class);
