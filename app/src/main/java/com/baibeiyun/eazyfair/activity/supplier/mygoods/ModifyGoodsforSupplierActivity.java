...
/*
    商品信息修改Activity
 */
public class ModifyGoodsforSupplierActivity extends BaseActivity implements View.OnClickListener {
    private RelativeLayout fanhui_rl;//返回
    private EditText input_goods_number;//公司货号
    private EditText input_goods_name;//商品名称
    private EditText input_goods_unit_et;//商品单位
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_modify_goods_for_supplier);
        initYuyan();
        initView();
        initData();
    }
    ...
    private void initYuyan() {
        ...
        language = CursorUtils.selectYuYan(ModifyGoodsforSupplierActivity.this);
        if (language != null) {
            tag = language.getTag();
            if (tag.equals("en")) {
    ...
    private void initView() {
        ...
        fanhui_rl.setOnClickListener(ModifyGoodsforSupplierActivity.this);
        huobi_ll.setOnClickListener(ModifyGoodsforSupplierActivity.this);
        tiaokuan_ll.setOnClickListener(ModifyGoodsforSupplierActivity.this);
        add.setOnClickListener(ModifyGoodsforSupplierActivity.this);
        upload_image_iv.setOnClickListener(ModifyGoodsforSupplierActivity.this);
        keep_bt.setOnClickListener(ModifyGoodsforSupplierActivity.this);
        outbox_weight_unit_ll.setOnClickListener(ModifyGoodsforSupplierActivity.this);
        centerbox_weight_unit_ll.setOnClickListener(ModifyGoodsforSupplierActivity.this);
        goods_unit_ll.setOnClickListener(ModifyGoodsforSupplierActivity.this);
    ...
    private void initData() {
        ...
        myCommodity = CursorUtils.selectById(ModifyGoodsforSupplierActivity.this, id);
        adapter = new MyDiyAdapter(datas, ModifyGoodsforSupplierActivity.this);
        ...
        input_goods_unit_et.setText(myCommodity.getUnit());//商品数量
        ...
        tiaokuan_tv.setText(myCommodity.getPrice_clause());
    ...
    public void onClick(View view) {
        MyCommodity myCommodity = CursorUtils.selectById2(ModifyGoodsforSupplierActivity.this, id);
        switch (view.getId()) {
            //返回
            case R.id.fanhui_rl:
                finish();
            ...
            case R.id.image1_iv:
                ...
                GraffitiActivity.startActivityForResult(ModifyGoodsforSupplierActivity.this, params1, REQ_CODE_GRAFFITI_EDIT_ONE);
                break;
            case R.id.image2_iv:
                byte[] product_imgs2 = myCommodity.getProduct_imgs2();
                Bitmap bitmap2 = BitmapUtils.Bytes2Bimap(product_imgs2);
                ...
                GraffitiActivity.startActivityForResult(ModifyGoodsforSupplierActivity.this, params2, REQ_CODE_GRAFFITI_EDIT_TWO);
            ...
            case R.id.image3_iv:
                ...
                GraffitiActivity.startActivityForResult(ModifyGoodsforSupplierActivity.this, params3, REQ_CODE_GRAFFITI_EDIT_THREE);
            ...
            case R.id.image4_iv:
                ...
                GraffitiActivity.startActivityForResult(ModifyGoodsforSupplierActivity.this, params4, REQ_CODE_GRAFFITI_EDIT_FOUR);
                break;
        }
    }
    ...
    private void showPopuWindow(final View v, int status) {
        dropList.clear();
        initDate(status);
        View mV = LayoutInflater.from(ModifyGoodsforSupplierActivity.this).inflate(R.layout.listview_popupwindow, null);
        ...
        ArrayAdapter adapter = new ArrayAdapter(ModifyGoodsforSupplierActivity.this, android.R.layout.simple_list_item_1, dropList);
        ...
        backgroundAlpha(ModifyGoodsforSupplierActivity.this, 0.5f);//0.0-1.0
        popupWindow.showAtLocation(v, Gravity.CENTER, 0, 0);
        popupWindow.setOnDismissListener(
                new PopupWindow.OnDismissListener() {
                    @Override
                    public void onDismiss() {
                        backgroundAlpha(ModifyGoodsforSupplierActivity.this, 1f);
                    }
                });
    }
    ...
    private void initPopupWindow() {
        ...
        //设置背景半透明
        backgroundAlpha(ModifyGoodsforSupplierActivity.this, 0.5f);
        //关闭事件
        ...
        if (requestCode == REQUEST_IMAGE) {
            if (resultCode == RESULT_OK) {
                ...
                if (mSelectPath.size() == 1 && tag.equals("2")) {
                    ...
                    GraffitiActivity.startActivityForResult(ModifyGoodsforSupplierActivity.this, params, REQ_CODE_GRAFFITI);
    ...
    private void updata() {
        //获得修改后的数据
        String serial_number = input_goods_number.getText().toString().trim();//货号
        ...
        int goods_type = myCommodity.getGoods_type();//商品类型 供应商0 采购商1
        ...
        MyCommodity myCommodity = new MyCommodity(id, serial_number, goodsname, goodsunit,
                ...
                centerboxweightunit);
        MyCommodityDao myCommodityDao = new MyCommodityDao(ModifyGoodsforSupplierActivity.this);

        //修改数据
        int rows = myCommodityDao.updataAll(myCommodity);
        if (rows == 0) {
            Toast.makeText(ModifyGoodsforSupplierActivity.this, R.string.modify_failed, Toast.LENGTH_SHORT).show();
        } else {
            Toast.makeText(ModifyGoodsforSupplierActivity.this, R.string.modify_success, Toast.LENGTH_SHORT).show();
        }
    ...
    private void selectGallery() {
        Intent intent = new Intent(ModifyGoodsforSupplierActivity.this, MultiImageSelectorActivity.class);
        // 是否显示拍摄图片,显示
