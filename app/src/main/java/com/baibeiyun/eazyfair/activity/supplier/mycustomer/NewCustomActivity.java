...
import com.baibeiyun.eazyfair.adapter.MyDiyAdapterForNewCustomer;
...
public class NewCustomActivity extends BaseActivity implements View.OnClickListener {
    private RelativeLayout fanhui_rl;//返回
    private EditText input_custom_xin_et, input_custom_ming_et;//姓，名
    private EditText input_company_name_et;//公司名
    private EditText input_phonenumber_et;//电话号码
    private EditText input_postcode_et;//邮编
    private EditText input_email_et;//邮箱地址
    private EditText input_other_et;//备注
    private ImageView add_email_iv;//自定义添加邮箱地址
    private MyListView diy_add_lv;
    private EditText unique_id_et;
    //国家 省份 城市 区县
    private LinearLayout country_ll, province_ll, city_ll, area_ll;
    //国家 省份 城市 区县
    private TextView country_tv, province_tv, city_tv, area_tv;
    ...
    //得到用户当前输入的数据
    private String name, companyname, jobforcustome, phonenumber, postcode, email, address, industry_type, unique_id, other;
    byte[] bytes_bg;
    ...
    private void initview() {
        ...
        job_ll.setOnClickListener(NewCustomActivity.this);


        company_logo_iv.setOnClickListener(NewCustomActivity.this);
        fanhui_rl.setOnClickListener(NewCustomActivity.this);
        save_bt.setOnClickListener(NewCustomActivity.this);
        add_email_iv.setOnClickListener(NewCustomActivity.this);

        country_ll.setOnClickListener(NewCustomActivity.this);
        province_ll.setOnClickListener(NewCustomActivity.this);
        city_ll.setOnClickListener(NewCustomActivity.this);
        area_ll.setOnClickListener(NewCustomActivity.this);

        adapter = new MyDiyAdapterForNewCustomer(datas, NewCustomActivity.this);
            ...
            case R.id.save_bt:
                ...
                if (myCustomer != null) {
                    if (myCustomer.getUnique_id().equals(unique_id)) {
                        Toast.makeText(NewCustomActivity.this, R.string.not_add, Toast.LENGTH_SHORT).show();
                    } else {
                        saved();
                    }
    ...
    private void popupwindow3(final int type) {
        ml = LayoutInflater.from(NewCustomActivity.this);
        ...
        backgroundAlpha(NewCustomActivity.this, 0.5f);// 0.0-1.0
        mPopupWindow.showAtLocation(country_ll, Gravity.CENTER, 0, 0);
        mPopupWindow.setOnDismissListener(new PopupWindow.OnDismissListener() {
            @Override
            public void onDismiss() {
                backgroundAlpha(NewCustomActivity.this, 1f);
            }
        });
    ...
    class CountryAdapter extends BaseAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            TextView tv = new TextView(NewCustomActivity.this);
    ...
    private void saved() {
        if (!name.equals("") && !companyname.equals("") && !email.equals("")) {
            ...
            myCustomer.setCustomer_type(0);
            myCustomer.setUnique_id(unique_id);
            //创建一个方法层对象
            MyCustomerDao myCustomerDao = new MyCustomerDao(NewCustomActivity.this);
            //执行该方法层中添加的方法
            myCustomerDao.insertdata(myCustomer);
            finish();
        } else {
            ToastUtil.showToast2(NewCustomActivity.this, R.string.check_info);
        }
    ...
    private void initPopupWindow() {
        ...
        //设置背景半透明
        backgroundAlpha(NewCustomActivity.this, 0.5f);
        //关闭事件
    ...
    private void showImage(String imaePath) {
        //图片压缩的方法
        bitmap = ImageFactoryandOther.ratio(imaePath, 200, 200);
    ...
    private void popupwindow2() {
        ...
        lv.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                                      ...
                                      public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                                          ...
                                          horizontalListViewAdapter_goods = new HorizontalListViewAdapter(NewCustomActivity.this, tempSelcetGoodsList);
