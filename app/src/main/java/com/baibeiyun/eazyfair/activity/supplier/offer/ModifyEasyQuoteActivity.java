...
public class ModifyEasyQuoteActivity extends BaseActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_modify_easy_quote);
        initYuyan();
        initView();
        initData();
    }
    ...
    private void initYuyan() {
        ...
        language = CursorUtils.selectYuYan(ModifyEasyQuoteActivity.this);
        if (language != null) {
    ...
    private void initData() {
        ...
        imageViewList.add(image3_iv);
        imageViewList.add(image4_iv);
        String content = easyQuote.getContent();
        content_et.setText(content);
        input_goods_name_et.setText(easyQuote.getGoods_name());
    }
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.image1_iv:
                ...
                GraffitiActivity.startActivityForResult(ModifyEasyQuoteActivity.this, params1, REQ_CODE_GRAFFITI_EDIT_ONE);
                break;
            case R.id.image2_iv:
                byte[] product_imgs2 = easyQuote.getGoods_img2();
                Bitmap bitmap2 = BitmapUtils.Bytes2Bimap(product_imgs2);
                ...
                GraffitiActivity.startActivityForResult(ModifyEasyQuoteActivity.this, params2, REQ_CODE_GRAFFITI_EDIT_TWO);
            ...
            case R.id.image3_iv:
                ...
                GraffitiActivity.startActivityForResult(ModifyEasyQuoteActivity.this, params3, REQ_CODE_GRAFFITI_EDIT_THREE);
                break;
            case R.id.image4_iv:
                byte[] product_imgs4 = easyQuote.getGoods_img4();
                Bitmap bitmap4 = BitmapUtils.Bytes2Bimap(product_imgs4);
                ...
                GraffitiActivity.startActivityForResult(ModifyEasyQuoteActivity.this, params4, REQ_CODE_GRAFFITI_EDIT_FOUR);
                break;
            //保存
    ...
    private void updata() {
        ...
        if (allPictureUrl == null) {
            product_imgs1 = easyQuote.getGoods_img1();
            product_imgs2 = easyQuote.getGoods_img2();
            product_imgs3 = easyQuote.getGoods_img3();
            product_imgs4 = easyQuote.getGoods_img4();
        } else {
            // 2016/12/7 计算出有几个“|”线
        ...
        String uniqued_id = easyQuote.getUniqued_id();
        easyQuote = new EasyQuote(id, product_imgs1, product_imgs2, product_imgs3, product_imgs4, goods_name, content, uniqued_id);
        EasyQuoteDao easyQuoteDao = new EasyQuoteDao(ModifyEasyQuoteActivity.this);
        int row = easyQuoteDao.upData(easyQuote);
        if (row == 0) {
            Toast.makeText(ModifyEasyQuoteActivity.this, R.string.modify_failed, Toast.LENGTH_SHORT).show();
        } else {
            Toast.makeText(ModifyEasyQuoteActivity.this, R.string.save_success, Toast.LENGTH_SHORT).show();
            finish();
        }
    ...
    private void initPopupWindow() {
        ...
        //设置背景半透明
        backgroundAlpha(ModifyEasyQuoteActivity.this, 0.5f);
        //关闭事件
    ...
    private class popupDismissListener implements PopupWindow.OnDismissListener {
        ...
        public void onDismiss() {
            backgroundAlpha(ModifyEasyQuoteActivity.this, 1f);
        }
    }

    //拍照和选择相册的方法
    private void selectGallery() {
        Intent intent = new Intent(ModifyEasyQuoteActivity.this, MultiImageSelectorActivity.class);
        // 是否显示拍摄图片,显示
        ...
        if (requestCode == REQUEST_IMAGE) {
            if (resultCode == RESULT_OK) {
                ...
                if (mSelectPath.size() == 1 && tag.equals("2")) {
                    ...
                    GraffitiActivity.startActivityForResult(ModifyEasyQuoteActivity.this, params, REQ_CODE_GRAFFITI);
