...
public class DetaiEasyInquiryActivity extends BaseActivityforBuyer implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_detai_easy_inquiry);
        initYuyan();
        initView();
        initData();
        initAboutPic();
    ...
    private void initYuyan() {
        ...
        language = CursorUtils.selectYuYan(DetaiEasyInquiryActivity.this);
        if (language != null) {
    ...
    private void initData() {
        ...
        goodsname_tv.setText(easyInquiry.getGoods_name());
        content_tv.setText(easyInquiry.getContent());
        ...
        for (int i = 0; i < resId.length; i++) {
            ...
            imageView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View arg0) {
                    // 跳到查看大图界面
                    Intent intent = new Intent(DetaiEasyInquiryActivity.this, ShowBigPicture.class);
                    intent.putExtra("position", position);
                    intent.putExtra("DataType", DataType.easyinquirytype_id);
