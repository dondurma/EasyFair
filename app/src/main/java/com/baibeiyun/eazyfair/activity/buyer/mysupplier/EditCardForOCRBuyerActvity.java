...
public class EditCardForOCRBuyerActvity extends BaseActivityforBuyer implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_edit_card_for_ocr_buyer_actvity);
        initYuyan();
        initview();
        initData();
        selectInfo();
    ...
    private void initData() {
        ...
        String tel_main = intent.getStringExtra("tel_main");
        String tel_mobile = intent.getStringExtra("tel_mobile");
        String tel_home = intent.getStringExtra("tel_home");
        String tel_inter = intent.getStringExtra("tel_inter");
    ...
    private void initview() {
        ...
        again_photo_rl.setOnClickListener(EditCardForOCRBuyerActvity.this);
        save_rl.setOnClickListener(EditCardForOCRBuyerActvity.this);
        ...
        one_ll.setOnClickListener(EditCardForOCRBuyerActvity.this);
        two_ll.setOnClickListener(EditCardForOCRBuyerActvity.this);
        three_ll.setOnClickListener(EditCardForOCRBuyerActvity.this);
        four_ll.setOnClickListener(EditCardForOCRBuyerActvity.this);
            ...
            case R.id.save_rl:
                ...
                if (myCustomer != null) {
                    if (myCustomer.getName().equals(name) && myCustomer.getCompany_name().equals(companyname) && myCustomer.getUnique_id().equals(unique_id)) {
                        ...
                        SelectQRcodeorOCRForBuyerActivity.activity.finish();
                    }
                } else {
                    saved();
                    SelectQRcodeorOCRForBuyerActivity.activity.finish();
    ...
    private void saved() {
        if (!name.equals("") && !companyname.equals("") && !eamil.equals("")) {
            ...
            byte[] bytes = BitmapUtils.compressBmpFromBmp(bitmap_no);
            byte[] bytes1 = BitmapUtils.compressBmpFromBmp(bitmap);
            //创建一个实体类对象
            ...
            myCustomer.setBackground_pic(bytes1);

            byte[] bytes2 = BitmapUtils.compressBmpFromBmp(bitmap);
            myCustomer.setCompany_logo(bytes2);
            ...
            ToastUtil.showToast2(EditCardForOCRBuyerActvity.this, R.string.check_info);
        }
    ...
    private void popupwindow(final int type) {
        ml = LayoutInflater.from(EditCardForOCRBuyerActvity.this);
        ...
        backgroundAlpha(EditCardForOCRBuyerActvity.this, 0.5f);// 0.0-1.0
        mPopupWindow.showAtLocation(one_ll, Gravity.CENTER, 0, 0);
        mPopupWindow.setOnDismissListener(new PopupWindow.OnDismissListener() {
            @Override
            public void onDismiss() {
                backgroundAlpha(EditCardForOCRBuyerActvity.this, 1f);
            }
        });
    }
    ...
    class OneAdapter extends BaseAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            TextView tv = new TextView(EditCardForOCRBuyerActvity.this);
    ...
    private void popupwindow2() {
        ...
        lv.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                                      ...
                                      public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                                          ...
                                          horizontalListViewAdapter_goods = new HorizontalListViewAdapter(EditCardForOCRBuyerActvity.this, tempSelcetGoodsList);
