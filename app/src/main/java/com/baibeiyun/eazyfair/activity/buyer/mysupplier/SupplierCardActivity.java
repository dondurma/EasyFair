...
public class SupplierCardActivity extends BaseActivityforBuyer implements View.OnClickListener {
    private ImageView background_card_iv;
    private RelativeLayout fanhui_rl;
    private RoundImageView logo;
    private TextView name;
    private TextView job_et;
    private TextView commpany_et;
    ...
    private String image;//得到上传图片的String类型的数据
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_supplier_card);
        initYuyan();
        initView();
        initData();
        initDataforIndustry();
    ...
    private void initData() {
        ...
        if (split.length == 1) {
            ...
            for (String s : split1) {
                ...
                horizontalListViewAdapter_goods = new HorizontalListViewAdapter(SupplierCardActivity.this, tempSelcetGoodsList);
    ...
    private void initPopupWindow(final int tag) {
        ...
        //设置背景半透明
        backgroundAlpha(SupplierCardActivity.this, 0.5f);
        //关闭事件
    ...
    private void showpopupWindow(final int type) {
        ...
        ml = LayoutInflater.from(SupplierCardActivity.this);
...
//        mPopupWindow.setHeight(height/4);
        ...
        mPopupWindow.setBackgroundDrawable(dw);
        backgroundAlpha(SupplierCardActivity.this, 0.5f);//0.0-1.0
        if (type == 1) {
        ...
        mPopupWindow.setOnDismissListener(new PopupWindow.OnDismissListener() {
            ...
            public void onDismiss() {
                backgroundAlpha(SupplierCardActivity.this, 1f);
            }
        });
    }
    ...
    private void showImage(String imaePath, int type) {
        if (type == 1) {
            ...
            bm = ImageFactoryandOther.ratio(imaePath, 300, 400);
            logo.setImageBitmap(bm);
            image = ImageFactoryandOther.convertIconToString(bm);
        }

    }


    //根据点击当前item 的id来查询的方法
    public ArrayList<MyCustomer> selectforId() {
        list.clear();
        //创建一个方法层的对象
        MyCustomerDao myCustomerDao = new MyCustomerDao(SupplierCardActivity.this);
        //执行该方法查询的方法
    ...
    private void updata() {
        ...
        String commpanyname_data = commpany_et.getText().toString().trim();
        ...
        if (industry_two_data != null && industry_three_data != null && s != null) {
            industry_data = industry_one_data + "|" + industry_two_data + "|" + industry_three_data + "|" + s;
        } else if (industry_two_data != null && industry_three_data != null) {
            industry_data = industry_one_data + "|" + industry_two_data + "|" + industry_three_data;
        } else if (industry_one_data != null && industry_two_data != null && industry_three_data == null && s == null) {
            industry_data = industry_one_data + "|" + industry_two_data;
        } else if (industry_one_data != null && industry_two_data == null && industry_three_data == null && s == null) {
            industry_data = industry_one_data;
        }
        ...
        //构建需要修改的数据
        myCustomer = new MyCustomer(id, name_data, commpanyname_data, phone_data, email_data, address_data, industry_data, job_data, company_logo, remarks_data, fax_data, web_data, accounts_data, create_time, customer_type, postcode_data, myCustomer.getUnique_id(), background_pic);
        MyCustomerDao myCustomerDao = new MyCustomerDao(this);
        int rows = myCustomerDao.updatedata2(myCustomer);
        if (rows == 0) {
            ToastUtil.showToast2(SupplierCardActivity.this, R.string.modify_failed);
        } else {
            ToastUtil.showToast2(SupplierCardActivity.this, R.string.modify_success);
        }
    }
...
//        three_tv.setText(oneList.get(0).getTwo_list().get(0).getThree_list().get(0).getThree());
    ...
    class OneAdapter extends BaseAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            TextView tv = new TextView(SupplierCardActivity.this);
