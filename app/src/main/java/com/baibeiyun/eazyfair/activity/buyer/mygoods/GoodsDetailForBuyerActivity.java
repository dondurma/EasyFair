...
public class GoodsDetailForBuyerActivity extends BaseActivityforBuyer implements View.OnClickListener {
    ...
    private ListView inquiry_customer_lv;//报价供应商
    private XunJiaRecordAdapter xunJiaRecordAdapter;//报价供应商的适配器
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        context = this;
        setContentView(R.layout.activity_goods_detail_for_buyer);
        initYuyan();
        initview();
        initData();
        initAboutPic();
    ...
    private void getOfferData() {
        ...
        for (MyInquiry myInquiry : myInquiries) {
            ...
            data.put("name_tv", myInquiry.getSupplier_name());
            data.put("price_tv", myInquiry.getPrice());
            data.put("time_tv", myInquiry.getInquiry_time());
    ...
    private void initYuyan() {
        ...
        language = CursorUtils.selectYuYan(GoodsDetailForBuyerActivity.this);
        if (language != null) {
    ...
    private void initview() {
        ...
        fanhui_rl.setOnClickListener(GoodsDetailForBuyerActivity.this);
        more_rv.setOnClickListener(GoodsDetailForBuyerActivity.this);
    }
    ...
    private void initData() {
        ...
        goodsDetailParameterAdapter = new GoodsDetailParameterAdapter(datas, GoodsDetailForBuyerActivity.this);
        ...
        myInquiries = CursorUtils.selectYiByCommodityId(GoodsDetailForBuyerActivity.this, id);
        getOfferData();
        xunJiaRecordAdapter = new XunJiaRecordAdapter(datas1, GoodsDetailForBuyerActivity.this);
    ...
    private void initPopupWindow() {
        ...
        //设置背景半透明
        backgroundAlpha(GoodsDetailForBuyerActivity.this, 0.5f);
        //关闭事件
        ...
        msg_ch_ll.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(GoodsDetailForBuyerActivity.this, SendGoodsDataByBuyerActvity.class);
                intent.putExtra("id", id);//id号
                intent.putExtra("tag", 2);//采购商为2
    ...
    private class popupDismissListener implements PopupWindow.OnDismissListener {
        ...
        public void onDismiss() {
            backgroundAlpha(GoodsDetailForBuyerActivity.this, 1f);
        }
    ...
    private void selectById() {
        myCommodity = CursorUtils.selectById(GoodsDetailForBuyerActivity.this, id);
    }
        ...
        for (int i = 0; i < resId.length; i++) {
            ...
            imageView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View arg0) {
                    // 跳到查看大图界面
                    Intent intent = new Intent(GoodsDetailForBuyerActivity.this, ShowBigPicture.class);
