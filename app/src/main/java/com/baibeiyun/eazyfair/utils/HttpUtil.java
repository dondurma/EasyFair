...
public class HttpUtil {
	...
	public static final String USERNAME="c37e9605-a790-449d-a652-d7b93927fdb9";//开发者平台API帐号
	public static final String PASSWORD="uUryMrVaHjONkxEwfvxLJEgSyDARec";//开发者平台API密码
	...
	public static String getSendXML(String action,String ocrLang,String keyLang,String ext) {
		...
		arr.add(new String[] { "ocrlang", 2+""});
		arr.add(new String[] { "keylang",  keyLang});
		arr.add(new String[] { "ext",ext });
		arr.add(new String[] { "er","0" });//0:不显示坐标，默认为0，1：显示座标
	...
	public static byte[] Inputstream2byte(FileInputStream is) {
		if (is == null)
			return null;
	 ...
	 * @throws IOException
	 */
	public static byte[] WriteFromStream(FileInputStream is){
