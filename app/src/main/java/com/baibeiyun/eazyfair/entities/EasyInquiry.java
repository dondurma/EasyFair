...
public class EasyInquiry implements Serializable {
    private int _id;
    ...
    public EasyInquiry(int _id, byte[] goods_img1, byte[] goods_img2, byte[] goods_img3, byte[] goods_img4, String goods_name, String content, String uniqued_id, String code) {
        this._id = _id;
    ...
    public EasyInquiry(int _id, byte[] goods_img1, byte[] goods_img2, byte[] goods_img3, byte[] goods_img4, String goods_name, String content, String uniqued_id) {
        this._id = _id;
        this.goods_img1 = goods_img1;
        this.goods_img2 = goods_img2;
        this.goods_img3 = goods_img3;
    ...
    public EasyInquiry(int _id, byte[] goods_img1, String goods_name, String uniqued_id, String code) {
        this._id = _id;
        this.goods_img1 = goods_img1;
        this.goods_name = goods_name;
        this.uniqued_id = uniqued_id;
    ...
    public EasyInquiry(byte[] goods_img1, byte[] goods_img2, byte[] goods_img3, byte[] goods_img4) {
        this.goods_img1 = goods_img1;
        this.goods_img2 = goods_img2;
        this.goods_img3 = goods_img3;
        this.goods_img4 = goods_img4;
