...
public class WoDeGongYingShangFragment extends Fragment implements View.OnClickListener {
    private View view;
    ...
    private TextView sendWayTv;//发送方式
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        view = inflater.inflate(R.layout.wodegongyingshang_layout, null);
        initYuyan();
        initView(view);
        initEvent();
        initDataforIndustry();
    ...
    private void initYuyan() {
        ...
        language = CursorUtils.selectYuYan(getActivity());
        if (language != null) {
...
//        addTv.setOnClickListener(this);
    ...
    private void initView(View view) {
        ...
        myUser = CursorUtils.selectOurInfo(getActivity());
                    ...
                    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                        ...
                        switch (status) {
                            case 2://商品选择
                                ...
                                break;
                            case 3://发送方式
                                String s1 = caiGouShangList.get(position);
                                sendWayTv.setText(s1);
                                break;
                        }
                ...
                if (!"".equals(one_tv.getText().toString())) {
                    ...
                    if (caiGouShangIDList.size()!=0) {
                        ...
                        mHandler.postDelayed(new Runnable() {
                            ...
                            public void run() {
                                //根据多个id来查询商品
                                myCommodities = CursorUtils.selectCommodityIds(getActivity(), caiGouShangIDList);
                                initEmailData(
                                        new GetEmail() {
                                            @Override
    ...
    private void searchDate(int flag) {
        ...
        switch (flag) {
            case 2://商品选择
                ...
                Cursor cursor2 = myCommodityDao.SelectforType();
...
//                            Log.d("tempSelcetGoodsList", "onItemClick: " + tempSelcetIndustry.get(i));
                        }
                        mPopupWindow.dismiss();
                    }
                }
    ...
    private void writeContentToPDF() throws Exception {
        ...
        File file = new File("sdcard/EasyFair/GoodsDetailsforBuyer.pdf");
    ...
    private void initEmailData(final GetEmail getEmail) {
        ...
        SharedPreferences edit = SharedprefenceStore.getSp();
        String tokens = edit.getString(SharedprefenceStore.TOKEN, "");
        JSONObject jsonObject = new JSONObject();
