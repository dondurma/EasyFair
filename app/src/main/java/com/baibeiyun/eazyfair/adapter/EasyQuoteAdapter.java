...
public class EasyQuoteAdapter extends BaseAdapter {
    ...
    public EasyQuoteAdapter(ArrayList<Map<String, Object>> datas, Context c, Map<Integer, String> list, List<CheckBox> mlist) {
        this.datas = datas;
        this.c = c;
        this.list = list;
        this.mlist = mlist;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        holder.edit_bt.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent(view.getContext(), ModifyEasyQuoteActivity.class);
        ...
        holder.detail_bt.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                int tag = (int) view.getTag();
                int id = (int) datas.get(tag).get("_id");
                Intent intent = new Intent(view.getContext(), DetailEasyQuoteActivity.class);
                intent.putExtra("id", id);
                view.getContext().startActivity(intent);
            }
        });
    ...
    public void showAlertDialog(final Context context, int message) {
        ...
        builder.setPositiveButton(R.string.determine, new DialogInterface.OnClickListener() {
            public void onClick(DialogInterface dialog, int which) {
                ...
                EasyQuoteDao easyQuoteDao=new EasyQuoteDao(c);
                EasyQuote easyQuote=new EasyQuote();
                easyQuote.set_id(id);
                easyQuoteDao.deleteById(easyQuote);
                datas.remove(tag);
