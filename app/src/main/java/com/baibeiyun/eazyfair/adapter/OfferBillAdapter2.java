 ...
 */
public class OfferBillAdapter2 extends BaseAdapter {
    ...
    public OfferBillAdapter2(ArrayList<Map<String, Object>> datas, Context c, Map<Integer, Integer> list, List<CheckBox> mlist) {
        this.datas = datas;
        this.c = c;
        this.list = list;
        this.mlist = mlist;
    ...
    public View getView(final int i, View convertview, ViewGroup viewGroup) {
        ...
        holder.inquiry_customer_bt.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent(view.getContext(), DetailGoodsforSupplierActvity.class);
