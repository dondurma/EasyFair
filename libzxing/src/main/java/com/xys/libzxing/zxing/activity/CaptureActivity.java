    ...
    public void onCreate(Bundle icicle) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.KITKAT) {
            ...
            if (tag == 1) {
                ...
                tintManager.setStatusBarTintResource(R.color.green_color);//通知栏所需颜色
            }
        ...
        if (tag == 1) {
            fanhui_rl.setBackgroundResource(R.color.blue);
        } else if (tag == 2) {
            fanhui_rl.setBackgroundResource(R.color.green_color);
        }
